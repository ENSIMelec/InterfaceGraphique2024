...
class TeamSelectionPage(tk.Frame):
    def __init__(self, parent, on_team_selected):
        ...
        self.yellow_team_button = tk.Button(self.left_frame, text="Equipe Jaune", font=("Helvetica", 14, "bold"), command=lambda: self.select_team("Jaune"), bd=2, relief="groove")
        self.yellow_team_button.place(relx=0.5, rely=0.5, anchor="center")

        self.blue_team_button = tk.Button(self.right_frame, text="Equipe Bleue", font=("Helvetica", 14, "bold"), command=lambda: self.select_team("Bleue"), bd=2, relief="groove")
    ...
    def __init__(self, parent, team, return_callback, show_steps_selection):
        ...
        for i in range(1, 5):
            ...
            if self.team == "Jaune" and i == 1:
                ...
                button_text = "Stratégie N°1 (MODIFIÉE)"
            button = tk.Button(self.frame_with_buttons, text=button_text, font=("Helvetica", 12, "bold"), command=lambda strategy_number=i: self.on_strategy_selected(strategy_number, json_filename), bd=2, relief="groove")
...
class StepsSelectionPage(tk.Frame):
    def __init__(self, parent, strategy_number, return_callback):
        ...
        self.steps_frame.place(relx=0.5, rely=0.5, anchor="center")
        ...
        for step_text in steps_text:
            step_label = tk.Label(self.steps_frame, text=step_text, font=("Helvetica", 14, "bold"), bg="#FFFF99", bd=2, relief="groove", width=40)
