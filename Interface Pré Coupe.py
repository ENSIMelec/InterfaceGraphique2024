    ...
    def __init__(self, parent, team, return_callback, show_steps_selection):
        ...
        for i in range(1, 5):
            ...
            if self.team == "Jaune" and i == 1:
                ...
                button_text = "Stratégie N°1 (MODIFIÉE)"
            button = tk.Button(self.frame_with_buttons, text=button_text, font=("Helvetica", 24, "bold"), command=lambda strategy_number=i: self.on_strategy_selected(strategy_number, json_filename), bd=2, relief="groove")
